...
- [personas.md](personas.md) — Who we are building for
- [competitor-analysis.md](competitor-analysis.md) — What already exists
- [PRD.md](PRD.md) — What we are building and why
- [scoring-algorithm.md](scoring-algorithm.md) — PMOS risk scoring logic
